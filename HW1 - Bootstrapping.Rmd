...
Intalling relevant libraries. Quantmode helps us to download several years of daily data on these ETFs.
```{r}
library(mosaic)
library(quantmod)
library(foreach)
...
So average return in this portfolio is $100600.2 and value at risk is $2899.006

4) Next we will create an aggressive portfolio which increases our return as well as our risk. Below is the weight we considered for this portfolio:
...
Average return in this portfolio is $102412.9 and value at risk is $13001.7
